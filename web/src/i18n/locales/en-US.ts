export default {
    ...
    expertLibrary: {
        ...
        subtitle: "Cloned from WorkBuddy's Expert Center, Skill Market, and Connectors — callable freely inside the canvas.",
        tabs: { expert: "Experts", skill: "Skills", connector: "Connectors" },
        category: "Category",
        search: "Search name, description, or tags",
        total: "{{count}} {{kind}}",
        detail: "Details",
        invoke: "Invoke",
        invoked: "Opened the canvas agent with the call prompt prefilled",
        agentNotRunning: "No local Canvas Agent detected. Follow the guide to start and connect it before invoking.",
        invokeHint: "Send it in the agent panel on the right to invoke it inside the canvas",
        drawerPrereq: "Connect the local Canvas Agent before invoking: run npx -y @basketikun/canvas-agent@latest in a terminal, then connect in the agent panel.",
        agentSetup: {
            title: "No local Canvas Agent detected",
            desc: "Invoking requires a locally running Canvas Agent service (default http://127.0.0.1:17371). Please start and connect it first, then come back and click invoke.",
            step1Title: "1. Start the Canvas Agent",
            step1: "Run npx -y @basketikun/canvas-agent@latest in a terminal, or launch it via the matching plugin in Codex.",
            step2Title: "2. Get the credentials",
            step2: "On startup it prints the Local URL and Connect token, and writes them to ~/.infinite-canvas/canvas-agent.json.",
            step3Title: "3. Connect inside the canvas",
            step3: "Open the agent panel → connection/setup tab, paste the Connect token and click connect (Local URL is auto-filled).",
            note: "After connecting, click invoke again to upload images, enter prompts, set permissions, and send normally.",
            confirm: "Got it",
        },
        ...
        copyPrompt: "Copy call prompt",
        promptCopied: "Call prompt copied",
        empty: "No matching {{kind}} found",
        myExperts: {
            title: "My Experts",
            create: "Create Expert",
            count: "My Experts · {{count}}",
            category: "My Experts",
        },
        createExpert: {
            title: "Create Expert",
            tabAi: "AI Create",
            tabManual: "Manual",
            aiDesc: "Describe the expert role you want. The AI will produce a complete profile (name / category / description / capabilities / call prompt). Confirm to add it to My Experts and invoke it as a canvas node.",
            aiPlaceholder: "e.g. a Xiaohongshu copywriting expert who knows viral hooks and platform tone.",
            aiFallbackRequirement: "a general-purpose all-round expert",
            aiHint: "After clicking, the request is sent to the canvas agent panel on the right, and the AI reply is captured automatically.",
            aiCreate: "AI Create",
            aiSent: "Request sent to the canvas agent. Once it replies, click Parse & Create.",
            aiOutput: "AI Output",
            aiOutputPlaceholder: "The AI reply shows here automatically. You can also paste a profile manually and parse it.",
            aiWatching: "Watching",
            aiCaptured: "Captured AI reply",
            parseCreate: "Parse & Create",
            parseToForm: "Fill form",
            parseFailed: "Could not parse an expert profile from the content. Check the format or fill it in manually.",
            parseFailedHint: "At least a name and a description are required. Ask the AI to regenerate, or switch to Manual.",
            fieldName: "Expert name",
            fieldNamePlaceholder: "e.g. Xiaohongshu Copywriter",
            fieldNameRequired: "Please enter the expert name",
            fieldCategory: "Category",
            fieldCategoryPlaceholder: "e.g. Writing",
            fieldDescription: "Description",
            fieldDescriptionRequired: "Please enter a description",
            fieldFeatures: "Capabilities",
            fieldFeaturesExtra: "One per line, describing what this expert is good at.",
            fieldTags: "Tags",
            fieldTagsPlaceholder: "e.g. copywriting, xiaohongshu, viral",
            fieldTagsExtra: "Used for search. Separate multiple tags with spaces or commas.",
            fieldCallPrompt: "Call prompt",
            fieldCallPromptExtra: "The instruction prefix prefilled into the agent input when invoking this expert on the canvas.",
            manualCreate: "Save as My Expert",
            defaultCallPrompt: "Act as the expert 「{{name}}」 and help me complete the following task based on my needs:",
            created: "Created expert: {{name}}",
        },
        addSkill: {
            title: "Add Skill",
            installedCount: "Installed {{count}}",
            needAgentTitle: "Not connected to a local Canvas Agent",
            needAgentDesc: "Importing, creating, or installing skills from a link all depend on a locally running Canvas Agent. Please connect first.",
            connectAgent: "Connect",
            tabImport: "Import",
            tabCreate: "Create",
            tabLink: "Install from Link",
            dropHint: "Drop or choose SKILL.md / a skill folder / .zip; multiple files and folders are supported",
            autoInstall: "Auto-install safe skills after parsing (skip risky ones)",
            requirements: "Skill file requirements",
            requirement1: "Must include SKILL.md (or at least one .md) whose frontmatter declares name and description.",
            requirement2: "name allows only lowercase letters, digits and hyphens (e.g. my-skill); description is at most 1024 chars and no angle brackets.",
            chooseZip: "Choose .zip",
            chooseFolder: "Choose folder",
            parsedSummary: "Parsed {{total}} skills (safe {{safe}} · risky {{risky}})",
            installSelected: "Install selected",
            risky: "Risky",
            parseFailures: "{{count}} files could not be parsed",
            noParseResult: "No installable skill was parsed from the selected files / folder.",
            autoInstalling: "Auto-installing {{count}} safe skills…",
            installed: "Installed {{count}} skill(s) to the local Canvas Agent",
            installPartial: "Some skills failed to install: {{failed}}",
            installFailed: "Install failed",
            originManual: "Manual",
            aiCreate: "AI Create Skill",
            aiPromptPrefix: "Send the request to skill-creator to generate a skill:",
            aiPromptSuffix: "(After sending, come back here and paste the generated SKILL.md into the manual form, or upload it under Import.)",
            aiPlaceholder: "Describe what you want this skill to do",
            aiHint: "The AI produces a complete skill file. Copy it back to Import or Create to finish installing.",
            aiButton: "Create with AI",
            aiExample: "e.g. a skill that rewrites Chinese tech articles into English READMEs",
            manualCreate: "Create skill manually",
            manualButton: "Create & Install",
            fieldName: "Skill name (name)",
            fieldNameRequired: "Please enter the skill name",
            fieldNamePattern: "Name allows only lowercase letters, digits and hyphens, and cannot start or end with a hyphen",
            fieldDisplayName: "Display name",
            fieldDisplayNamePlaceholder: "Name shown in the agent skill list (optional)",
            fieldDescription: "Description",
            fieldDescriptionRequired: "Please enter a description",
            fieldDescriptionAngle: "Description cannot contain angle brackets < or >",
            fieldInstructions: "Instructions",
            fieldInstructionsRequired: "Please enter the skill instructions",
            linkHint: "Paste a GitHub / Gitee repo or a direct SKILL.md / .zip link; skills inside are parsed and installed automatically.",
            linkPlaceholder: "https://github.com/owner/repo or a SKILL.md direct link",
            linkResolve: "Resolve & Install",
            linkInstallHint: "Supports repo root, sub-paths (e.g. /skills/my-skill) and a specific branch (?ref=...).",
            remoteFound: "Resolved {{count}} skill(s) from the link",
            errors: {
                nameInvalid: "Invalid name (only lowercase letters, digits, hyphens)",
                descriptionMissing: "Missing description",
                descriptionTooLong: "Description exceeds 1024 chars",
                descriptionHasAngleBrackets: "Description contains angle brackets",
                instructionsMissing: "Missing instructions",
                instructionsTooLarge: "Instructions exceed 256KB",
                frontmatterMissing: "Missing valid frontmatter (name / description)",
                noMarkdownFile: "No SKILL.md or .md file found",
            },
            remoteErrors: {
                invalidUrl: "Invalid link format. Check and retry.",
                unsupported: "Source not supported. Use GitHub / Gitee or a direct link.",
                network: "Network request failed. Check the link or local network.",
                notFound: "Repository or file not found (404).",
                noSkills: "No skill (SKILL.md) was resolved from the link.",
                tooMany: "Too many skills. Narrow the scope or specify a sub-path.",
            },
        },
        myConnectors: {
            title: "My Connectors",
            count: "My Connectors · {{count}}",
        },
        addConnector: {
            title: "Connector Manager",
            subtitle: "Configure MCP servers and custom connectors to extend the canvas agent with more tools.",
            note: "Configs are saved in your local browser. The canvas agent connects on demand when you invoke, and no persistent connection is opened in the page. Only connect to services you trust.",
            search: "Search connectors",
            configure: "Configure connector",
            importText: "Import as text",
            importLink: "Install from link",
            count: "{{count}} connectors in total",
            noMatch: "No matching connector",
            empty: "No custom connectors yet",
            emptyHint: "Click \"Configure connector\" to add an MCP server or custom connector",
            createTitle: "Configure connector",
            editTitle: "Edit connector",
            back: "Back to list",
            fieldName: "Service name",
            fieldNamePlaceholder: "e.g. github-mcp",
            fieldNameRequired: "Please enter a service name",
            fieldTransport: "Transport",
            transportStdio: "Local command",
            transportSse: "SSE",
            transportHttp: "HTTP",
            fieldCommand: "Command",
            fieldCommandPlaceholder: "e.g. npx / uvx / node / python",
            fieldCommandRequired: "Please enter a command",
            fieldArgs: "Arguments",
            fieldArgsPlaceholder: "One argument per line, e.g.:\n-y\n@modelcontextprotocol/server-github",
            fieldUrl: "Endpoint URL",
            fieldUrlPlaceholder: "https://example.com/mcp",
            fieldUrlRequired: "Please enter a valid http(s) endpoint URL",
            ...
            addPair: "Add item",
            fieldDescription: "Description",
            fieldDescriptionPlaceholder: "Describe what this connector can do for the agent (optional)",
            enabled: "Enable this connector",
            disabledTag: "Disabled",
            save: "Save",
            update: "Save changes",
            savedCount: "Saved {{count}} connectors",
            updated: "Connector updated",
            removed: "Connector deleted: {{name}}",
            edit: "Edit",
            remove: "Delete",
            removeConfirm: "Delete this connector?",
            enabledToast: "Enabled: {{name}}",
            disabledToast: "Disabled: {{name}}",
            importHint: "Paste an MCP config to import in bulk: supports {\"mcpServers\": {…}}, {\"servers\": {…}}, an array, or a single server object.",
            importPlaceholder: '{\n  "mcpServers": {\n    "github": {\n      "command": "npx",\n      "args": ["-y", "@modelcontextprotocol/server-github"]\n    }\n  }\n}',
            parse: "Parse",
            parsedCount: "Parsed {{count}} connectors",
            saveAll: "Save all",
            linkHint: "Supports GitHub / Gitee repos, direct config links (.mcp.json / mcp.json / connectors.json), or config code blocks in a README.",
            linkPlaceholder: "https://github.com/owner/repo or a direct config link",
            resolve: "Resolve & preview",
            errors: {
                invalidJson: "Invalid JSON. Check quotes and commas.",
                noServers: "No recognizable connector config found",
                nameMissing: "Config is missing a service name",
                endpointMissing: "Config is missing a command or endpoint URL",
                emptyText: "Paste the config content first",
                tooMany: "Up to 50 connectors per import",
                invalidUrl: "Invalid link format. Check and retry.",
                unsupported: "Source not supported. Use GitHub / Gitee or a direct config link.",
                network: "Network request failed. Check the link or local network.",
                notFound: "No connector config found in the repository",
            },
        },
        pluginTabs: {
            openLibrary: "Open expert library",
            invoke: "Invoke",
            placed: "Placed as a canvas node",
            noCanvas: "Open a canvas first, then choose \"Invoke as node\"",
            count: "{{count}} {{kind}}",
            empty: "No {{kind}} yet",
            kindHint: {
                expert: "Experts are invocable role-based capabilities with their own prompt and skill list",
                skill: "Skills are SKILL.md capability packs installable into the local agent",
                connector: "Connectors are MCP-style configs for external services (stdio / SSE / HTTP)",
            },
        },
    },
    assets: {
    ...
    canvas: {
        ...
        toolbar: {
            ...
            background: "Background image / video", uploadBackground: "Upload background", replaceBackground: "Replace background", clearBackground: "Clear background", backgroundHint: "Any image or video format; stored in the local media library", backgroundOpacity: "Background opacity", fontOpacity: "Text opacity", nodeOpacity: "Node opacity", resetOpacity: "Click to reset to 100%", backgroundFailed: "Background upload failed",
        },
        project: {
    ...
    topNav: {
        ...
        downloadDesktopFallback: "No direct installer link yet — opened the desktop release page instead",
    },
    home: {
    ...
    version: {
        ...
        online: {
            title: "Online update",
            check: "Preview impact",
            apply: "Update now",
            rollback: "Roll back",
            available: "Update available: {{version}}",
            upToDate: "Already up to date",
            protectedHint: "Customizations are preserved automatically ({{count}} protected entries)",
            baseVersion: "Custom base {{version}}",
            impactOverwrite: "Overwrite upstream files",
            impactAdd: "Add upstream files",
            impactMerge: "Three-way merge",
            impactKeepLocal: "Keep local",
            impactSkipped: "Protected (skipped)",
            verifyPassed: "Customization integrity check passed ({{total}} items)",
            verifyFailed: "{{count}} integrity checks failed - rolled back automatically",
            conflicts: "{{count}} upstream change(s) overlapped with local edits and kept the local version",
            rolledBack: "Rolled back to the state before the update.",
            restartHint: "Update finished: the version is injected at build time, restart the dev server (or rebuild) to apply it.",
            devOnly: "Online update needs the local dev server. Run the command below in the project root (--check to preview, --rollback to revert).",
            desktopNote: "On desktop, use the three-layer update below (plugins / frontend / shell) - no need to re-download the whole app.",
            failed: "Operation failed, please check the log",
        },
        layer: {
            title: "Three-layer update (desktop)",
            desktopNote: "You are using the desktop app. The three-layer update covers plugins / frontend / shell without re-downloading the whole app.",
            plugins: "Plugins",
            frontend: "Frontend bundle",
            shell: "Desktop shell",
            current: "Current: {{version}}",
            remote: "Remote: {{version}}",
            noRemote: "Remote: not configured",
            changed: "{{count}} files pending",
            upToDate: "Up to date",
            notConfigured: "Remote manifest not configured (CANVAS_UPDATE_MANIFEST_URL)",
            check: "Check frontend update",
            apply: "Apply frontend update",
            checking: "Checking...",
            updating: "Updating...",
            applied: "Frontend update downloaded; restart the desktop app to apply",
            shellAvailable: "Desktop shell update available ({{version}})",
            shellDownloaded: "Desktop shell update downloaded; restart to apply",
            installShell: "Restart and install",
            noShellUpdate: "Desktop shell is up to date",
            source: "Update source",
            sourceFromEnv: "Set by environment variable",
            sourcePlaceholder: "https://your-site/build-manifest.json",
            saveSource: "Save",
            sourceSaved: "Saved",
            sourceHint: "Paste the build-manifest.json URL of your deployed site (e.g. Cloudflare Pages / Nginx). Save it to check and incrementally update the frontend.",
            invalidUrl: "Enter a URL starting with http(s)://",
            needSource: "Please fill in and save the update source first",
        },
    },
    config: {
        ...
        channelEditor: {
            ...
            sync: "Sync to Codex",
            syncHint: "Write this provider's endpoint, API key and text model into the local Codex config (the original file is backed up automatically) so Agent chat reuses the same provider. Restart the local Agent afterwards.",
            synced: "Synced to Codex (model: {{model}}). Restart the local Agent to apply.",
            syncMissing: "Enter an API endpoint and API key first.",
            syncProtocolUnsupported: "Only OpenAI-compatible providers can be synced to Codex.",
            syncNoModel: "This provider has no models yet; select models and mark one as \"Text\".",
            syncUnavailable: "Sync is unavailable in this environment (the local dev server is required).",
            syncFailed: "Failed to sync to Codex.",
            capabilities: {
                image: "Image",
                video: "Video",
                text: "Text",
    ...
    agent: {
        ...
        connect: { pluginTitle: "Option 1: Use the Codex plugin", pluginText: "Install the Infinite Canvas plugin in the Codex app and launch the canvas through it. The plugin starts the local Agent and supplies the connection details automatically.", directTitle: "Option 2: One-click start inside the canvas", directText: "Click the button to launch the local Agent directly inside the canvas — no terminal commands needed. It auto-connects once started.", commandCopied: "Command copied", pluginReminder: "Codex plugin note", pluginReminderText: "The tool list enters the Codex context and consumes additional tokens only after installing the Codex plugin or adding MCP manually. Running npx -y @basketikun/canvas-agent@latest alone does not install MCP.", removePlugin: "Remove plugin", removeMcp: "Remove manual MCP", copyCommand: "Copy command", title: "Connect local Agent", description: "Choose the connection method that fits your workflow.", webConnection: "Web connection", autoDiscover: "The Local URL and Connect token are discovered automatically by default. Enter them manually only if discovery fails.", conversationState: "Conversation: {{state}}", disconnect: "Disconnect", connect: "Connect", localAddress: "Local address", urlPlaceholder: "For example http://127.0.0.1:17371", token: "Connection token", tokenPlaceholder: "Discover automatically or enter the Connect token" , startBackend: "Start backend with one click", startingBackend: "Starting the local Agent…", startBackendFailed: "Failed to start. Please start it manually and retry.", startBackendLocalOnly: "One-click start only works from a local address on this machine: open the canvas via localhost (or 127.0.0.1) on this machine, or start the local Agent manually and then connect.", startBackendUnavailable: "This environment does not expose the one-click start endpoint: a deployed web page cannot launch a process on your machine. Start the Canvas Agent locally first, then come back and click Connect.", startBackendHint: "No terminal commands needed — click the button to launch the local Agent inside the canvas (default 127.0.0.1:17371).", interopTitle: "Call from Codex / Trae / DSH as a plugin", interopText: "Register the local Agent as an MCP server in the tools below to invoke canvas capabilities directly from them. The DeepSeek Harness (DSH) desktop app already bundles and auto-starts this Agent.", interopConfig: "MCP config (works with any MCP-capable tool)", interopCopy: "Copy config", interopNote: "Add the JSON above to any MCP-capable tool such as Codex, Trae, Claude Desktop, or VS Code to enable interop.", lnaTitle: "Grant “Local Network Access”", lnaText: "You are connecting to the local Agent (127.0.0.1) from a public web page. The browser requires a “Private Network Access” grant: click “Allow” in the permission prompt, then retry. Once granted, the HTTPS page may call the local Agent and mixed content is waived.", lnaChromium: "Tip: use a Chromium-based browser such as Chrome or Edge. Firefox has not implemented this grant and may be unable to reach the local Agent.", lnaFirefox: "Tip: your browser may not support the “Local Network Access” grant. Switch to a Chromium-based browser such as Chrome or Edge to connect to the local Agent."},
    ...
    onboarding: {
        title: "4 canvas plugins preinstalled for you",
        desc: "These self-developed plugins are enabled by default and ready to use from “New node” without any setup.",
        enabledNote: "They are enabled by default. To disable or inspect them, open the Plugins panel.",
        manager: "Open plugins panel",
        gotIt: "Got it",
        plugin: {
            clipshot: "Storyboard Workbench · split a script into a customizable grid of shots and generate per-shot images",
            directorDesk: "White-model Previz · import models, set cameras and lights, export previz video",
            jlmlh: "3D Director · upstream background sync, camera timeline, screenshot to canvas",
            openreel: "OpenReel Video Editor · timeline editing, transitions, filters, subtitles, ffmpeg export",
        },
    },
    locale: {
        zhCN: "简体中文",
